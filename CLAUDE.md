# Shadow Guardian — Port a PS Vita

Port de `Shadow-Guardian-HD-v1-0-1-UK-RU.apk` (Android) a PS Vita vía soloader. Generado con **psvita-port-toolkit**.

## Estructura

- `shadowguardian_extract/` — APK extraído (gitignored).
...
- ABI: armeabi-v7a (preferida: armeabi-v7a)
